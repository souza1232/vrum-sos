...
export const metadata: Metadata = {
  title: 'Assistência Automotiva em Mucuri BA — Mecânico, Guincho e Borracheiro',
  description: 'Precisa de mecânico, guincho, borracheiro ou chaveiro em Mucuri? Encontre prestadores automotivos disponíveis 24h em Mucuri e região. Atendimento rápido pelo WhatsApp.',
  keywords: [
    'mecânico em Mucuri',
    'guincho em Mucuri',
    'borracheiro em Mucuri',
    'chaveiro automotivo Mucuri',
    'eletricista automotivo Mucuri',
    'guincho pesado Mucuri',
    'assistência automotiva Mucuri BA',
    'socorro automotivo Mucuri',
    'carro quebrado Mucuri',
    'mecânico 24h Mucuri',
    'guincho 24h Mucuri Bahia',
  ],
  alternates: {
    canonical: 'https://vrumsos.com.br/mucuri',
  },
  openGraph: {
    title: 'Assistência Automotiva em Mucuri BA | Vrum SOS',
    description: 'Mecânico, guincho, borracheiro e chaveiro em Mucuri. Atendimento 24h pelo WhatsApp.',
    url: 'https://vrumsos.com.br/mucuri',
  },
}
...
export default function MucuriPage() {
  return (
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-black mb-4">
            Assistência Automotiva em <span className="text-orange-400">Mucuri</span>
          </h1>
          <p className="text-gray-300 text-lg mb-8">
            Mecânico, guincho, borracheiro e chaveiro em Mucuri e região. Encontre o prestador mais próximo e entre em contato direto pelo WhatsApp.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/socorro?cidade=Mucuri"
      ...
      <section className="py-14 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-black text-slate-900 text-center mb-2">
            Serviços disponíveis em Mucuri
          </h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {servicos.map(s => (
              <Link
                key={s.label}
                href={`/socorro?cidade=Mucuri&servico=${s.label}`}
      ...
      <section className="py-14 px-4">
        <div className="max-w-3xl mx-auto">
          <div className="bg-slate-900 rounded-2xl p-8 text-white text-center">
            ...
            <h2 className="text-2xl font-black mb-2">Carro quebrado em Mucuri?</h2>
      ...
      <section className="py-10 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {['Nova Viçosa', 'Alcobaça', 'Caravelas', 'Teixeira de Freitas', 'Prado'].map(cidade => (
              <Link
                key={cidade}
